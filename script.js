...
let currentColor2 = [0.0, 1.0, 0.0];
let currentColor3 = [1.0, 0.0, 1.0];
...
const Hexagon = function () {
    ...
    let hexagonVerts = [
     // X, Y              R   G    B
        0.0, 0.0,     ...currentColor1,
        -0.5, 0.0,      ...currentColor2,
        -0.25, 0.5,    ...currentColor3,

        0.0, 0.0,       ...currentColor1,
        -0.25, 0.5,     ...currentColor2,
        0.25, 0.5,      ...currentColor3,

        0.0, 0.0,       ...currentColor1,
        0.25, 0.5,      ...currentColor2,
        0.5, 0.0,       ...currentColor3,
...
function changeColor(){
    currentColor1 = [Math.random(), Math.random(), Math.random()];
    currentColor2 = [Math.random(), Math.random(), Math.random()];
    currentColor3 = [Math.random(), Math.random(), Math.random()];
    Hexagon();
}
